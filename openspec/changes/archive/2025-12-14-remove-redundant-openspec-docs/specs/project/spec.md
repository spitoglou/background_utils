...
#### Scenario: No redundant OpenSpec auxiliary files
- **WHEN** the openspec directory is reviewed
- **THEN** only essential files exist (AGENTS.md, project.md, MEMORY_BANK_INTEGRATION.md, specs/)
- **AND** no duplicate workflow guides or reference files exist
